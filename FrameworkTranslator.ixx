/**
 * @file      FrameworkTranslator.ixx
 * @brief     翻译器模块
 * @author    IYATT-yx
 * @copyright Copyright (c) 2026 IYATT-yx.
 *            Licensed under the MIT License. See LICENSE file in the project root for full license information.
 */
export module FrameworkTranslator;
import std;
...
public:
	 ...
	 * @return 翻译器实例
	 */
	static FrameworkTranslator& getInstance();
	/**
	 * @brief 初始化翻译器
...
{
	return FrameworkTranslator::getInstance().translate(text, domain);
}
