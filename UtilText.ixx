...
{
	// 文本类型列表
	UiUniversalPicker::AcRxClassVector textClassList =
	{
		AcDbMText::desc(),
		AcDbText::desc()
	};
...
export namespace UtilText
{
	 ...
	 */
	void createMTextMatrix(double colWidth, double colStep, double rowStep, const UtilIoCsvModule::AcStringMatrix& matrixData, AcGePoint3d topLeftPt, double dLineSpacingFactor = 1.0);
