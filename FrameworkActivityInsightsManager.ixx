/**
 * @file      FrameworkActivityInsightsManager.ixx
...
export module FrameworkActivityInsightsManager;
import std;
...
export class FrameworkActivityInsightsManager
{
public:
    FrameworkActivityInsightsManager() = default;
    ~FrameworkActivityInsightsManager() = default;
